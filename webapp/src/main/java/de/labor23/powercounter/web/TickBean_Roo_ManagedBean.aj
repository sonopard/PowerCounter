...
privileged aspect TickBean_Roo_ManagedBean {
    ...
    public HtmlPanelGrid TickBean.populateCreatePanel() {
        ...
        meterCreateInput.setValueExpression("itemLabel", expressionFactory.createValueExpression(elContext, "#{meter.gpioId} #{meter.meterName} #{meter.address} #{meter.ticksPerKWH}", String.class));
    ...
    public HtmlPanelGrid TickBean.populateEditPanel() {
        ...
        meterEditInput.setValueExpression("itemLabel", expressionFactory.createValueExpression(elContext, "#{meter.gpioId} #{meter.meterName} #{meter.address} #{meter.ticksPerKWH}", String.class));
    ...
    public List<PowerMeter> TickBean.completeMeter(String query) {
        ...
        for (PowerMeter powerMeter : PowerMeter.findAllPowerMeters()) {
            String powerMeterStr = String.valueOf(powerMeter.getGpioId() +  " "  + powerMeter.getMeterName() +  " "  + powerMeter.getAddress() +  " "  + powerMeter.getTicksPerKWH());
